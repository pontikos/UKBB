...
#print(table(d$f.21000.0.0 <- ordered(d$f.21000.0.0, levels=lvl.1001, labels=lbl.1001)))
#print(table(d$f.21000.1.0 <- ordered(d$f.21000.1.0, levels=lvl.1001, labels=lbl.1001)))
#print(table(d$f.21000.2.0 <- ordered(d$f.21000.2.0, levels=lvl.1001, labels=lbl.1001)))
#print(table(d$f.22001.0.0 <- ordered(d$f.22001.0.0, levels=lvl.0009, labels=lbl.0009)))
#lvl.1002 <- c(1)
#lbl.1002 <- c("Caucasian")
#print(table(d$f.22006.0.0 <- ordered(d$f.22006.0.0, levels=lvl.1002, labels=lbl.1002)))
#ethnicity
d$ethnicity <- NA
